    ...
    public class UsuariosController : Controller
    {
        ...
        public async Task<IActionResult> Index(string buscar)
        {
            ...
            if (!String.IsNullOrEmpty(buscar))
            {
                ...
                //usuarios = usuarios.Where(d => d.Apellido!.Contains(buscar));
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Fecha,Clave")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Fecha,Clave")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
