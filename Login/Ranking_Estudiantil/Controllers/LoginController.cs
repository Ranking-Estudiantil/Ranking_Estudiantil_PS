...
namespace Ranking_Estudiantil.Controllers
{
    ...
    {
        private readonly Ranking_Estudiantil.Models.dbMyProjectContext _context;

        public LoginController(Ranking_Estudiantil.Models.dbMyProjectContext context)
        {
            _context = context;
        }
        ...
        {
            dbMyProjectContext _db = new dbMyProjectContext();
