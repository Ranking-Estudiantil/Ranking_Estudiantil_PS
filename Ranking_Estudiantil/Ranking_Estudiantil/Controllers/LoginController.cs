    ...
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Index(Person _usuario)
        {
           ...
           if(email == ""|| password =="") {
                ...
                ViewData["Message1"] = "Debe ingresar correo y contrasenia";
                return View();
            }
            else
            {
                ...
                if (usuario != null)
                {
                    SessionClass.Carrera = usuario.CareerID;
                    SessionClass.unidadAcademica = usuario.AcademicUnityID;
                    SessionClass.role = usuario.Role;
                    SessionClass.Id = usuario.PersonID;
                ...
                {
                    ViewData["Message"] = "Correo y/o contrania invalidas";
                    return View();
                }
            }
