...
namespace Ranking_Estudiantil.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        {
            if (SessionClass.role == "Docente" || SessionClass.role == "Director de carrera" || SessionClass.role == "Estudiante")
            {
            ...
            else
            {
                IQueryable<Student> student = from Student in _context.Students.Include(a => a.PeronStud).Include(c => c.PeronStud.career)
                                              ...
                                              join Career in _context.Careers on Person.CareerID equals Career.CareerID
                                              join AcademicUnity in _context.AcademicUnities on Person.AcademicUnityID equals AcademicUnity.AcademicUnityID
                                              where Student.Rank == 1 && Person.Status == 1 
                                              orderby Student.Score descending
                                              select Student;
                return View(await student.ToListAsync());
            }
        ...
        public async Task<IActionResult> Silver()
        {
            ...
            else
            {
                IQueryable<Student> student = from Student in _context.Students.Include(a => a.PeronStud).Include(c => c.PeronStud.career)
                                              ...
                                              join Career in _context.Careers on Person.CareerID equals Career.CareerID
                                              join AcademicUnity in _context.AcademicUnities on Person.AcademicUnityID equals AcademicUnity.AcademicUnityID
                                              where Student.Rank == 2 && Person.Status == 1 
                                              orderby Student.Score descending
                                              select Student;
        ...
        public async Task<IActionResult> Gold()
        {
            ...
            else
            {
                IQueryable<Student> student = from Student in _context.Students.Include(a => a.PeronStud).Include(c => c.PeronStud.career)
                                              ...
                                              join Career in _context.Careers on Person.CareerID equals Career.CareerID
                                              join AcademicUnity in _context.AcademicUnities on Person.AcademicUnityID equals AcademicUnity.AcademicUnityID
                                              where Student.Rank == 3 && Person.Status == 1 
                                              orderby Student.Score descending
                                              select Student;
        ...
        public async Task<IActionResult> Platinum()
        {
            ...
            else
            {
                IQueryable<Student> student = from Student in _context.Students.Include(a => a.PeronStud).Include(c => c.PeronStud.career)
                                              ...
                                              join Career in _context.Careers on Person.CareerID equals Career.CareerID
                                              join AcademicUnity in _context.AcademicUnities on Person.AcademicUnityID equals AcademicUnity.AcademicUnityID
                                              where Student.Rank == 4 && Person.Status == 1 
                                              orderby Student.Score descending
                                              select Student;
        ...
        public async Task<IActionResult> Diamond()
        {
            ...
            else
            {
                IQueryable<Student> student = from Student in _context.Students.Include(a => a.PeronStud).Include(c => c.PeronStud.career)
                                              ...
                                              join Career in _context.Careers on Person.CareerID equals Career.CareerID
                                              join AcademicUnity in _context.AcademicUnities on Person.AcademicUnityID equals AcademicUnity.AcademicUnityID
                                              where Student.Rank == 5 && Person.Status == 1 
                                              orderby Student.Score descending
                                              select Student;
        ...
        {
            if (SessionClass.role == "Docente" || SessionClass.role == "Director de carrera" )
            {
                IQueryable<Student> student = from Student in _context.Students.Include(a => a.PeronStud).Include(c => c.PeronStud.career)
                                              join Person in _context.People on Student.PersonID equals Person.PersonID
                                              join Career in _context.Careers on Person.CareerID equals Career.CareerID
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit2(int id, [Bind("ProjectsID,StudentsID,achievment,ProjectName,punctuation,Status,RegisterDate")] Projects projects,Student student)
        {
            string achieve;
            int punctuation, total;

            achieve = Request.Form["achievment"];
            punctuation = int.Parse(Request.Form["punctuation"]);
            if (achieve == "Logro Academico")
            {
                total = punctuation * 500;

            }
            else
            {
                total = punctuation * 200;
            }
            ...
            if (ModelState.IsValid)
            {
               student.Score = student.Score - total;
                projects.Status = 1;
